    ...
    <div class="hero-overlay">
      <div class="hero-content">
        ...
        <div class="hero-titles">
          <h1 class="hero-title">Beautiful aerial stock photography and video</h1>
        ...
        <div class="hero-search">
          ...
          <!-- Replace input with shared PhotoSearchInput -->
          <PhotoSearchInput
...
import PhotoSearchInput from '../../../../packages/shared-ui/src/components/PhotoSearchInput.vue'
</script>
<style scoped>
...
.hero {
  ...
  align-items: center;
  padding: 120px 0; /* vertically centers the text nicely */
}
